  ...
  en: {
    translation: {
      ...
      nav: {
        ...
        brandSubnav: {
          whyCosmos: "Why Cosmos",
          aboutCosmos: "About Cosmos",
      ...
      home: {
        ...
        collage: {
          ...
          pandiaStock:
            "Introducing the Pandia Glass Collection, the latest expression of Cosmos and Chris Connell's exploration of minimal glass, light and Australian design.",
          standard: "Standard",
          downloads: "Downloads",
      ...
      footer: {
        brandItems: ["Why choose Cosmos", "About Cosmos", "Sustainability", "Our Culture"],
        ...
        email: "Email",
        submit: "Submit",
        consent: "I agree to Cosmos terms and conditions",
  ...
  vi: {
    translation: {
      ...
      nav: {
        ...
        brandSubnav: {
          whyCosmos: "Vì sao chọn Cosmos",
          aboutCosmos: "Giới thiệu Cosmos",
      ...
      home: {
        ...
        collage: {
          ...
          pandiaStock:
            "Tự hào giới thiệu Bộ sưu tập Pandia Glass - tuyệt tác mới nhất, thể hiện hành trình của Cosmos và Chris Connell trong việc khám phá sự tối giản trong thủy tinh, ánh sáng và thiết kế đậm chất Úc.",
          standard: "Tiêu chuẩn",
          downloads: "Tải xuống",
      ...
      footer: {
        brandItems: ["Vì sao chọn Cosmos", "Giới thiệu Cosmos", "Phát triển bền vững", "Văn hóa của chúng tôi"],
        ...
        email: "Email",
        submit: "Gửi",
        consent: "Tôi đồng ý với điều khoản và điều kiện của Cosmos",
